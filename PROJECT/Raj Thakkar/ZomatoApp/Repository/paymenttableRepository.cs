...
{
    public class paymenttableRepository : GenericRepository<Paymenttable>, IPaymenttable
    {
        private readonly ZomatoApp_ProjectContext _context;
        public paymenttableRepository(ZomatoApp_ProjectContext context) : base(context)
        {
            _context=context;
        }
