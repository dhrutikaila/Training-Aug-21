...
namespace ZomatoApp.Repository
{
    ...
    public class ViewProductRepository : GenericRepository<ViewProduct>, IViewProduct
    {
        private readonly ZomatoApp_ProjectContext _context;
        public ViewProductRepository(ZomatoApp_ProjectContext context) : base(context)
        {
            _context=context;
        }
