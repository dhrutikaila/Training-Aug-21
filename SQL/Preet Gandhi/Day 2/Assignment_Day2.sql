...
--UPDATE Employees SET CommissionPct = '0.30' WHERE JobId = 'SA_MAN'
...
--7) Write a SQL statement to change job ID of employee which ID is 118, to SH_CLERK 
...
--9) Write a SQL statement to increase the minimum and maximum salary of PU_CLERK by 2000 as well as the salary 
--   for those employees by 20% and commission by 10% .
UPDATE dbo.Employees SET Salary+=(Salary * 0.20), CommissionPct+=(CommissionPct*0.10)  WHERE JobId = 'PU_CLERK'
