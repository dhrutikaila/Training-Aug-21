...
SELECT a.FIRST_NAME FROM EMPOLYEE a JOIN dbo.Departments b ON a.Department = b.DepartmentID
SELECT * FROM EMPOLYEE a LEFT JOIN dbo.Departments b ON a.Department = b.DepartmentID
SELECT a.FIRST_NAME FROM EMPOLYEE a RIGHT JOIN dbo.Departments b ON a.Department = b.DepartmentId
SELECT a.FIRST_NAME FROM EMPOLYEE a  JOIN EMPOLYEE b ON a.EMPLOYEE_ID = b.MANAGER_ID
SELECT * FROM EMPOLYEE a CROSS JOIN dbo.Departments b 
