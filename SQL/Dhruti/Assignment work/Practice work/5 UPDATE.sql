...
UPDATE Employee SET email='not work';
...
SELECT * FROM Employee where DepartmentID=110
...
FROM Department WHERE DepartmentName='Accounting');
select * from Employee
...
UPDATE Employee SET Salary=  CASE EmployeeID
