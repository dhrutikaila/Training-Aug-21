...
SELECT a.Cname FROM Deposit a JOIN  Deposit b ON a.Bname = b.Bname WHERE b.Cname = 'SUNIL'
SELECT a.Cname FROM Deposit a JOIN  Branch b ON a.Bname = b.Bname 
WHERE a.Bname IN  (Select City FROM Deposit WHERE Cname = 'SUNIL')
...
Deposit c JOIN CUSTOMER b ON b.CNAME = c.CNAME GROUP BY b.CITY HAVING 
COUNT(c.CNAME) >= ALL (SELECT COUNT(e.CNAME) FROM Deposit e,CUSTOMER d WHERE 
...
a JOIN Deposit b ON  b.CNAME = a.CNAME AND a.AMOUNT > 1000 AND a.AMOUNT > 2000;
