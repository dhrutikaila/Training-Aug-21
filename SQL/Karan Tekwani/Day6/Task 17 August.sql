...
select d.Cname,d.Bname,b.City from DepositeTable d join BranchTable b on d.Bname=b.Bname where b.City=(select b.City from DepositeTable d join BranchTable b on d.Bname=b.Bname where d.Cname='Sunil')
...
select * from DepositeTable where Bname=(select Bname from DepositeTable where Cname='Sunil') except select * from DepositeTable where Cname='Sunil'
...
select d.Cname,d.Amount,b.Amount from DepositeTable d join BorrowTable b on d.Cname=b.Cname where d.Amount>1000 and b.Amount>2000

--5. List All the Customers Living in NAGPUR and Having the Branch City as MUMBAI or DELHI
select C.Cname from BranchTable b join CustomerTable c on b.City=c.City where c.City='Nagpur' and (b.City='Mumbai' or b.City='Delhi')

--6. Count the Number of Customers Living in the City where Branch is Located
SELECT COUNT(c.Cname) FROM CustomerTable c JOIN BranchTable b ON c.CITY = b.CITY 