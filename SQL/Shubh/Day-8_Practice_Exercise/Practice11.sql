...
--Partial output of the query : job_id	Employees ID AC_ACCOUNT	206 AC_MGR	205 AD_ASST	200 AD_PRES	100 AD_VP	101 ,102 FI_ACCOUNT	  10 ,113 ,111 ,109 ,112 Sample table: employees
...
SELECT CONCAT(REPLICATE(0,6),MAX(Salary)) AS 'MAXIMUM SALARY',CONCAT(REPLICATE(0,6),MIN(Salary)) AS 'MINIMUM SALARY' FROM Employees
