...
UPDATE Employees
SET
Salary = Salary + (Salary * 0.25) WHERE DepartmentID = 40
UPDATE Employees
SET
Salary = Salary + (Salary * 0.15) WHERE DepartmentID = 90
UPDATE Employees
SET
Salary = Salary + (Salary * 0.10) WHERE DepartmentID = 110

/* query9 */
SELECT MAX(Salary),MIN(Salary) FROM Employees
UPDATE Employees 
SET Salary = Salary + (Salary + 2000),CommissionPct =CommissionPct + 10  WHERE (JobId='PU_CLERK' AND (Salary = 27600.00 OR Salary= 2100.00));
...
/*query8 */
SELECT FirstName,LastName,Salary*0.12 AS PF FROM Employees;
...
/* query12 */
SELECT EmployeeID,FirstName,LastName,LastName,Salary FROM Employees ORDER BY Salary;
