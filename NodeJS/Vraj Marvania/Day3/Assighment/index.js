...
console.log('`Wellcome to Rambo Rental Bikes`')
readline.question('`for  Bikes rant please enter BikeNumber --->`', (BikeNumber) => {
    readline.question('please enter PhoneNumber --->', (PhoneNumber) => {
        readline.question('please enter Name --->', (Name) => {
            readline.question('please enter Days--->', (Days) => {
                m1.set_data(BikeNumber, PhoneNumber, Name, Days)
                console.log(`your bike rant charge is ---> ${ m1.rentalcharge}`)
                console.log(m1.display_data)
                readline.close();
            })
        })
