...
// import
import{Applicant1} from './applicant';
import {Vacancy1} from './vacancy';




// create empty Array
var vacancy_Data:Vacancy1[] = [];

// add vacancy function
function Add_Vacancy(Tech:string, Exp:number,Sal:number,Total_Vac:number):void {
    vacancy_Data.push({Technology:Tech, Experience:Exp, Salary:Sal ,Total_Vacancies:Total_Vac})
}
// show data 
function show_Vacancy():void {
...
// create empty Array
var Applicant_Data: Applicant1[] = [];

// add applicant data function
       function Add_Applicant(Name:string,PhoneNo:number,Email:string,Exp:number,Tech:string):void {
            Applicant_Data.push({Name:Name, PhoneNumber:PhoneNo, Email:Email,Experience:Exp,Technology:Tech})
        }

// show data function
      function  Show_Applicant():void {
...
var newData: Applicant1[] = [];
function Add_Applicant1(Name:string,PhoneNo:number,Email:string,Exp:number,Tech:string):void {
    newData.push({Name:Name, PhoneNumber:PhoneNo, Email:Email,Experience:Exp,Technology:Tech})
}
// interview call for applicant data
Applicant_Data.forEach((a)=>{
    vacancy_Data.forEach((v)=>{
...
function interviewCall(){
    console.log(`Total no of Applicants: ${newData.length} and data \n`)
    console.log(newData);
}
